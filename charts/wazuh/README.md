...
| `indexer.config.tenants`                     | Configuration of tenants.yml                                                     | `{{ include "wazuh.indexer.tenants" . }}`                      |
| `indexer.config.nodesDn`                     | Configuration of nodes_dn.yml                                                    | `{{ include "wazuh.indexer.nodes_dn" . }}`                     |
| `indexer.config.whitelist`                   | Configuration of whitelist.yml                                                   | `{{ include "wazuh.indexer.whitelist" . }}`                    |
