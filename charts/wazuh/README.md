...
![Version: 0.1.1](https://img.shields.io/badge/Version-0.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.12.0](https://img.shields.io/badge/AppVersion-4.11.1-informational?style=flat-square)
...
| `indexer.cred.existingSecret`                | Name of the existingSecret with username and password Expected keys are:       | `""`                                               |
| `indexer.cred.username`                      | Name of the user.                                                              | `admin`                                            |
| `indexer.cred.password`                      | Value of the password.                                                         | `SecretPassword`                                   |
...
` |
| `dashboard.cred.existingSecret`                | Name of the existingSecret with username and password Expected keys are:       | `""`                                        |
| `dashboard.cred.username`                      | Name of the user.                                                              | `kibanaserver`                              |
| `dashboard.cred.password`                      | Value of the password.                                                         | `kibanaserver`                              |
...
| `wazuh.nodeSelector`                            |                                                                 | `{}`                                       |
| `wazuh.apiCred.existingSecret`                  | name of the existingSecret in the namespace.                    | `""`                                       |
