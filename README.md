...
![AppVersion: 5.0.0-beta1](https://img.shields.io/badge/AppVersion-5.0.0-beta1-informational?style=flat-square)
...
```bash
docker run --rm -ti wazuh/wazuh-indexer:5.0.0-beta1 bash /usr/share/wazuh-indexer/plugins/opensearch-security/tools/hash.sh`
```
...
This Helm chart has been tested with Wazuh version 5.0.0-beta1. Please note:
